const gozos = [
    {
        id: 1,
        title: "PRIMER GOZO",
        text: `Oh Sapientissima, 
Sabiduría del Padre Eterno,
que iluminas los cielos y la tierra:
...
Amén.`
    },
    {
        ...
        text: `Oh Adonai, 
Fuerza de Israel,
que apareciste en la zarza a Moisés:
ven a nuestras almas.
Amén.`
    },
    {
        ...
        text: `Oh Radix Jesse, 
Raíz de Jesé,
que te alzas como signo para los pueblos:
ven a nuestras almas.
Amén.`
    },
    {
...
Amén.`
    },
    {
        ...
        text: `Oh Emmanuel, 
Dios con nosotros,
esperanza y salvación de los pueblos:
ven a nuestras almas.
Amén.`
    },
    {
...
Era necesario en las miras de su amor que tomase la forma, las debilidades e ignorancia sistemática del hombre, que creciese para darle crecimiento espiritual; que sufriese, para morir a sus pasiones y a su orgullo y por eso el Verbo Eterno ardiendo en deseos de salvar al hombre resolvió hacerse hombre también y así redimir al culpable.`
    ...
    {
        id: 2,
        title: "Día Segundo - Consideración",
        text: `El Verbo eterno se halla a punto de tomar su naturaleza creada en la santa Casa de Nazaret en donde moraban María y José. Cuando la sombra del secreto divino vino a deslizarse sobre ella, María estaba sola engolfada en la oración. Pasaba las silenciosas horas de la noche en la unión más estrecha con Dios y mientras oraba, el Verbo tomó posesión de su morada creada.
...
La Virgen Inmaculada ha dado su asentimiento. El Arcángel ha desaparecido. Dios se ha revestido de una naturaleza creada; la voluntad eterna está cumplida y la creación completa. El Verbo se ha hecho carne, y aunque todavía invisible para el mundo, habita ya entre los hombres que su inmenso amor ha venido a rescatar.`
    ...
    {
        id: 3,
        title: "Día Tercero - Consideración",
        text: `Así había comenzado su vida encarnada el Niño Jesús. Consideremos el alma gloriosa y el Santo Cuerpo que había tomado, adorándolos profundamente.
...
Pidámosle que lave las nuestras en el sacramento de la penitencia para que el día de su dichosa Navidad nos encuentre purificados, perdonados y dispuestos a recibirle con amor y provecho espiritual.`
    ...
    {
        id: 4,
        title: "Día Cuarto - Consideración",
        text: `Desde el seno de su Madre comenzó el Niño Jesús a poner en práctica su eterna sumisión a Dios, que continuó sin la menor interrupción durante toda su vida. Adoraba a su Eterno Padre, le amaba, se sometía a su voluntad; aceptaba con resignación toda su debilidad, toda su humillación, todas sus incomodidades.
...
¿Deseamos hacer una verdadera oración? Empecemos por formarnos de ella una exacta idea, contemplado al Niño en el seno de su Madre. El Divino Niño ora y ora del modo más excelente. NO habla, no medita, ni se deshace en tiernos efectos. Su mismo estado, lo acepta con la intención de honrar a Dios, en su oración y en ese estado expresa altamente todo lo que Dios merece, y de qué modo quiere ser adorado por nosotros. Unámonos a las adoraciones del Niño Dios en el seno de María; unámonos a su profundo abatimiento, y sea éste el primer efecto de nuestro sacrificio a Dios. Desaparezcamos a nuestros propios ojos, y que Dios sea todo para nosotros.`
    ...
    {
        id: 5,
        title: "Día Quinto - Consideración",
        text: `Ya hemos visto la vida que llevaba el Niño Jesús en el seno de su purísima Madre; veamos hoy la vida que lleva también María durante el mismo espacio de tiempo.
...
Tal era la vida de expectativa de María! Era inaudita en sí misma, mas no por eso dejaba de ser el tipo magnífico de toda vida cristiana. No nos contentemos con admirar a Jesús residiendo en María, sino pensamos que en nosotros también reside por esencia, potencia y presencia.`
    ...
    {
        id: 6,
        title: "Día Sexto - Consideración",
        text: `Jesús había sido concebido en Nazaret, domicilio de José y María, y allí era de creerse que había de nacer, según todas las probabilidades. Más Dios lo tenía dispuesto de otra manera, y los profetas habían anunciado que el Mesías nacería en Belén de Judá, ciudad de David.
...
El Espíritu Santo arde en deseos de presentar a la luz del día esa santa humanidad, que El mismo ha formado con divino esmero.`
    ...
    {
        id: 8,
        title: "Día Octavo - Consideración",
        text: `Llegan a Belén José y María buscando hospedaje en los mesones, pero no encuentran, ya por hallarse todos ocupados, ya porque se les deshace a causa de su pobreza. Empero, nada puede turbar la paz interior de los que están fijos en Dios.
...
Eso era lo que había venido a buscar. El deseo de esas humillaciones era lo que había contribuido a hacerle tomar la forma humana. Oh! Divino Niño de Belén! Estos días que tantos han pasado en fiestas y diversiones o descansando mueblemente en cómodas y ricas mansiones, ha sido para vuestros padres un día de fatiga y vejaciones de toda clase. ¡Ay! el espíritu de Belén es el de un mundo que ha olvidado a Dios.

¡Cuántas veces no ha sido también el nuestro!.

Pónese el sol el 24 de diciembre detrás de los tejados de Belén y sus últimos rayos doran la cima de las rocas escarpadas que lo rodean. Hombres groseros, codean rudamente al Señor en las calles de aquella aldea oriental y cierran sus puertas al vera a su Madre.
...
La bóveda de los cielos aparece purpurina por encima de aquellas colinas frecuentadas por los pastores. Las estrellas van apareciendo unas tras otras. Algunas horas más y aparecerá el Verbo Eterno.`
    ...
    {
        id: 9,
        title: "Día Noveno - Consideración",
        text: `La noche ha cerrado del todo en las campiñas de Belén. Desechados por los hombres y viéndose sin abrigo, María y José han salido de la inhospitalaria población, y se han refugiado en una gruta que se encontraba al pie de la colina. Seguía a la Reina de los Ángeles el jumento que le había servido de cabalgadura durante el viaje y en aquella cueva hallaron un manso buey, dejado ahí probablemente por alguno de los caminantes que había ido a buscar hospedaje en la ciudad.
